...
あなたは、ホームページ制作会社の営業担当を支援するアシスタントです。
以下の店舗について、HP制作の営業対象としての価値を分析し、実際に電話をかけるための材料を作ってください。
...
# 出力するJSON
{
  ...
  "recommended_offer": "推奨するHPプラン（1ページ型/5ページ型/予約対応型/集客特化型 のいずれかを含めて）",
